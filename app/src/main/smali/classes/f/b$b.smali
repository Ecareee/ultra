...
.method public final a()Landroid/view/SubMenu;
    ...
    iput-boolean v0, p0, Lf/b$b;->h:Z

    iget-object v0, p0, Lf/b$b;->a:Landroid/view/Menu;

    iget v1, p0, Lf/b$b;->b:I

    iget v2, p0, Lf/b$b;->i:I

    iget v3, p0, Lf/b$b;->j:I

    iget-object v4, p0, Lf/b$b;->k:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v1}, Lf/b$b;->c(Landroid/view/MenuItem;)V
...
.method public final b(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Lf/b$b;->E:Lf/b;

    iget-object v0, v0, Lf/b;->c:Landroid/content/Context;
...
.method public final c(Landroid/view/MenuItem;)V
    ...
    invoke-virtual {v1, v4}, Lf/b;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_4
    iget-object v1, v1, Lf/b;->d:Ljava/lang/Object;

    .line 4
    iget-object v4, p0, Lf/b$b;->y:Ljava/lang/String;

    invoke-direct {v0, v1, v4}, Lf/b$a;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    sget-object v1, Lf/b;->e:[Ljava/lang/Class;

    iget-object v2, p0, Lf/b$b;->E:Lf/b;

    iget-object v2, v2, Lf/b;->a:[Ljava/lang/Object;

    invoke-virtual {p0, v0, v1, v2}, Lf/b$b;->b(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_d
    :goto_4
    iget-object v0, p0, Lf/b$b;->z:Lu/b;
    ...
    invoke-static {p1, v0}, Lu/d;->b(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lf/b$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lu/d;->f(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Lf/b$b;->n:C

    iget v1, p0, Lf/b$b;->o:I

    invoke-static {p1, v0, v1}, Lu/d;->a(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Lf/b$b;->p:C

    iget v1, p0, Lf/b$b;->q:I

    invoke-static {p1, v0, v1}, Lu/d;->e(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Lf/b$b;->D:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_10

    invoke-static {p1, v0}, Lu/d;->d(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V

    :cond_10
    iget-object v0, p0, Lf/b$b;->C:Landroid/content/res/ColorStateList;

    if-eqz v0, :cond_11

    invoke-static {p1, v0}, Lu/d;->c(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
