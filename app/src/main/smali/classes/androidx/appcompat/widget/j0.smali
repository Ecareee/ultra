...
.method public static m(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/j0;
    .locals 1
...
.method public static n(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroidx/appcompat/widget/j0;
    .locals 2
...
.method public final f(IILn/b;)Landroid/graphics/Typeface;
    .locals 9
    ...
    .line 4
    :cond_3
    sget-object v3, Lo/b;->b:Lj/e;

    invoke-static {v4, v5, p2}, Lo/b;->c(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3, v6}, Lj/e;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 5
    invoke-virtual {p3, v3, p1}, Ln/b;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-static {v3, v4}, Ln/a;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Ln/a$a;
    ...
    invoke-virtual {p3, v8, p1}, Ln/b;->a(ILandroid/os/Handler;)V
    ...
    invoke-static/range {v2 .. v7}, Lo/b;->a(Landroid/content/Context;Ln/a$a;Landroid/content/res/Resources;IILn/b;)Landroid/graphics/Typeface;
    ...
    :cond_6
    invoke-static {v2, v4, v5, v0, p2}, Lo/b;->b(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;

    move-result-object p2

    if-eqz p2, :cond_7

    invoke-virtual {p3, p2, p1}, Ln/b;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
